...
export const questions = [
  ...
  {
      id: 7,
      question: "Your IT team proposes moving sensitive data to overseas servers to save costs. However, the new jurisdiction has weak privacy protections.",
      options: {
          "A": {
  ...
  {
      id: 8,
      question: "Regulators announce a surprise audit of FinPeak's systems. Your team hasn't updated key processes for months. Team recommends a last-minute scramble to fix issues.",
      options: {
          "A": {
  ...
  {
      id: 9,
      question: "Late Friday evening, your PR manager rushes in. 'A small breach--0.05% of user data. It's tiny, barely newsworthy. If we announce it, users might panic. Should we quietly patch it or go public?'",
      options: {
          "A": {
  ...
  {
      id: 11,
      question: "Your marketing head proudly shows off a new newsletter design. 'The unsubscribe button is barely visible--it'll keep our retention high!'",
      options: {
          "A": {
  ...
  {
      id: 12,
      question: "Your audit reveals FinPeak collects user vacation data with no business relevance. Marketing insists it 'could be useful someday.'",
      options: {
          "A": {
  ...
  {
      id: 13,
      question: "Your CFO warns, 'Regulators flagged our outdated systems. If a breach happens, we're looking at ₹250 crore in penalties. Fixing it now delays Q3 goals.'",
      options: {
          "A": {
  ...
  {
      id: 14,
      question: "Our employees love using their personal devices,&quot; HR tells you. &quot;It boosts morale. But IT disagrees: Without security protocols, we're a breach waiting to happen.",
      options: {
          "A": {
  ...
  {
      id: 15,
      question: "An anonymous email claims: FinPeak is collecting user data without proper consent. Legal advises brushing it off, but compliance urges an internal review.",
      options: {
          "A": {
  ...
  {
      id: 18,
      question: "Several users report unauthorized transactions on their accounts. Your fraud detection system is outdated, and your tech team proposes an expensive upgrade.",
      options: {
          "A": {
  ...
  {
      id: 20,
      question: "A well-known but controversial influencer offers to partner with FinPeak. \"They have a massive following,' your marketing team argues.",
      options: {
          "A": {
  ...
  {
      id: 21,
      question: "Your HR team reports a breach: an employee's laptop was stolen, containing unencrypted user data. \"This could destroy trust\" warns compliance. \"We need to act fast.\"",
      options: {
          "A": {
  ...
  {
      id: 22,
      question: "A high-profile client's loan application is flagged for irregularities. \"Approving it could secure their loyalty\" says your sales lead. \"But rejection may protect us from future fallout\" warns compliance.",
      options: {
          "A": {
  ...
  {
      id: 24,
      question: "Your campus ambassadors are tasked with conducting surveys. They using G-Forms to collect responses with an implied understanding that it carries explicit consent.",
      options: {
          "A": {
  ...
  {
      id: 25,
      question: "\"Users want their data transferred to a competitor,\" your tech team groans. \"It's costly and complex.\"",
      options: {
          "A": {
